...
[B][C][00FF00]BY RAGNAR
[ff0000]━━━━━━━━━━━━━━━━━━━━━
[B][C][FF9900]D O N EㅤH A C K I N G
[B][C][E75480]Y O U RㅤA C C O U N T
[81DACA]━━━━━━━━━━━━━━━━━━━━━
[B][C][FF0000]IㅤAM ㅤRAGNAR
[CCFFCC]━━━━━━━━━━━━━━━━━━━━━
[B][C][81DACA]R1X ㅤTEAM ㅤYNYKㅤ ALKOL
[FFFF00]━━━━━━━━━━━━━━━━━━━━━
[B][C][00FF00]F O L L O WㅤM EㅤI NㅤI N S T A G R A Mㅤ[FFFFFF]@X1R_RAGNAR
[00008B]━━━━━━━━━━━━━━━━━━━━━
...
[B][C][FF0000]IㅤAM ㅤRAGNAR
[CCFFCC]━━━━━━━━━━━━━━━━━━━━━
[B][C][81DACA]X1R ㅤTEAM ㅤYNYKㅤ ALKOL
[FFFF00]━━━━━━━━━━━━━━━━━━━━━
[B][C][00FF00]F O L L O WㅤM EㅤI NㅤI N S T A G R A Mㅤ[FFFFFF]@X1R_RAGNAR
[00008B]━━━━━━━━━━━━━━━━━━━━━
[B][C][81DACA]I FㅤY O UㅤN O TㅤF A L L O WㅤM EㅤIㅤW I L LㅤB A NㅤY O U RㅤA C C O U N T
...
[7CFC00]✨ مرحباً!
[FFFFFF]❤️ شكراً لإضافتي  
[FFFFFF]⚡ لرؤية الأوامر  
[00FFFF]👉 أرسل /help أو أي إيموجي  

[FF1493]╠══════════════════════════╣

[FFD700]🤖 هل تريد شراء بوت؟
...
[7CFC00]✨ إذا كنت تريد شراء بوت TCP  
[FFFFFF]⚡ أو الحصول على صلاحيات ❤️  
[FFFFFF]📩 فقط تواصل معي  
...
[FFD700]✨ Developer —͟͞͞ </> X1R TEAM ⚡""", uid
                            )
                        )
                    except Exception as e:
...
#-------------------------------------------------------------#
                    if "1200" in data.hex()[0:4] and b"/help" in data:
                        try:
                            ...
                            clients.send(
                                self.GenResponsMsg(
                                        f"""[B][C][FFFF00]✨ R1X 	TEAM  BOT✨
[FFFFFF]مرحبا! هذه هي أوامر البوت 👇
...
""", uid
                            ...
                            clients.send(
                                    self.GenResponsMsg(
                                        f"""[C][B][FFD700] الأوامر الخاصة بالفريق [FF8800][B]
                            
  [7CFC00]فتح فريق 3 لاعبين
                   [00FFFF]/3
                   
  [7CFC00]فتح فريق 4 لاعبين
                   [00FFFF]/4
                   
  [7CFC00]فتح فريق 5 لاعبين
                   [00FFFF]/5
                   
  [7CFC00]فتح فريق 6 لاعبين
                   [00FFFF]/6
                   
  [7CFC00]تغيير عدد لاعبين الفريق
        [00FFFF]/change [3-6]
                  
  [7CFC00]دعوة أي لاعب
        [00FFFF]/inv [id]
        
  [7CFC00]الدخول إلى الفريق
        [00FFFF]/join [team code]
...
[7CFC00]════════════[FF69B4]""", uid
                            ...
                            clients.send(
                                    self.GenResponsMsg(
                                        f"""[C][B][FFD700] أوامر السبام [FF0000][B]
                            
   [00FFFF]سبام تغيير حجم الفريق
              [7CFC00]/team [id]
              
   [00FFFF]سبام طلبات صداقة
              [7CFC00]spam [id]
             
   [00FFFF]سبام دعوات الفريق
                [7CFC00]/x [id]
             
   [00FFFF]سبام طلبات الانضمام
                     [7CFC00]sm [id]
...
""", uid
                            ...
                            clients.send(
                                    self.GenResponsMsg(
                                        f"""[C][B][FFD700] أوامر الهجوم / اللاڨ [FF0000][B]
                            
   [00FFFF]الهجوم على أي فريق
              [7CFC00]/attack (team)
              
   [00FFFF]تشغيل إجباري للفريق
              [7CFC00]/start (team)
...
[7CFC00]════════════[FFA500]""", uid
                            ...
                            clients.send(
                                    self.GenResponsMsg(
                                        f"""[C][B][FFD700] أوامر الإيموت [00CED1][B]
                            
   [7CFC00]تشغيل أي رقصة بدون ID
              [00FFFF]/emote (uid) (1-409)
              
   [7CFC00]رقصة سلاح متطور
              [00FFFF]/evo (uid) (1-17)
              
   [7CFC00]تشغيل رقصة محددة
              [00FFFF]/play (uid) (emote-id)
              
   [7CFC00]سبام رقص
              [00FFFF]/smplay (uid) (emote-id)
...
[7CFC00]════════════[32CD32]""", uid
                            ...
                            clients.send(
                                    self.GenResponsMsg(
                                        f"""[C][B][FFD700] أوامر عامة [00CED1][B]
                            
   [7CFC00]الحصول على 100 لايك
             [00FFFF]/likes [id]

   [7CFC00]فحص حالة اللاعب
             [00FFFF]/status [id]
...
[7CFC00]════════════[1E90FF] """, uid
                            ...
                            clients.send(
                                    self.GenResponsMsg(
                                        f"""[C][B][FFD700] أوامر إضافية [FFFF00][B]
                            
   [7CFC00]التحدث مع الذكاء الإصطناعي
              [00FFFF]/ai [word]
              
   [7CFC00]الحصول على نوتيس مثل الهوكر
              [00FFFF]xr (team)
             
   [7CFC00]معرفة أدمن البوت
              [00FFFF]/admin
